...
/**
 * The 249 officially assigned ISO 3166-1 alpha-2 country codes.
 * COUNTRY_TO_CONTINENT maps 187 of them; codes such as CY, MT, MC, LI and
 * AD were refused as invalid when validation used it.
 */
...
export function isValidCountryCode(countryCode: string): boolean {
  return (
    ...
    ISO_3166_ALPHA2.has(countryCode.toUpperCase())
  );
}
